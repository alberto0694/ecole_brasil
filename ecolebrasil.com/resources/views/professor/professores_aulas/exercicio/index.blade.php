...
@section('content')
<div class="row">
	<a href="{{ route('professor.exercicio.novo') }}">
		<button class="btn btn-lg btn-success" style="margin-left: 30px">Novo Exercício</button>
	</a>
</div>
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Ecole Exercícios</h3>
			...
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				@foreach($exercicios as $exercicio)
					<tr>
						...
						<td>{{ $exercicio->modulo->titulo }}</td>
						<td>{{ $exercicio->modulo->agenda->labelCombo }}</td>
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								<a class="green" href="{{ route('professor.exercicio.editar', $exercicio->id) }}">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										<li>
											<a href="{{ route('professor.exercicio.editar', $exercicio->id) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
												<span class="green">
