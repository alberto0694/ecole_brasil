...
<body style="font-family: Arial, sans-serif; font-size:13px; color: #444444; min-height: 200px;" bgcolor="#E4E6E9" leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
	...
	<div class="row">
		...
		<h3 align="center" style="color: gray">Na semana antecede o início do curso criaremos um grupo no whats app no qual serão informados local, materiais necessários e facilidades próximas do local. Qualquer dúvida é só falar com a gente pelo nosso <b>WhatsApp 51 98953.5234</b>
		</h3>
		<div class="row">
