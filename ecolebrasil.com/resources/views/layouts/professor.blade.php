...
.label-info.arrowed-in:before {
    border-color: rgb(93, 14, 14);transparent;
}

.label-info.arrowed-in-right:after {
    border-color: rgb(93, 14, 14);transparent rgb(93, 14, 14);
}
...
#loading-admin-application-only {
    ...
    border-top: 16px solid rgb(93, 14, 14);; /* Blue */
    border-radius: 50%;
    width: 120px;
    height: 120px;
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
            ...
            <ul class="nav nav-list">
                <li class="">
                    <a href="{{ route('professor.profile.visualizar') }}">
                ...
                <li class="">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="{{ route('professor.modulo.index') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Listagem de Módulos
                            </a>
                ...
                <li class="">
                    ...
                    <ul class="submenu">
                        <li class="">
                            <a href="{{ route('professor.aula.index') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Aulas
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="{{ route('professor.exercicio.index') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Exercícios
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="{{ route('professor.videoconferencia.index') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Videoconferências
                            </a>
                            <b class="arrow"></b>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="{{ route('professor.aluno.visao') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Visão Aluno
                            </a>
