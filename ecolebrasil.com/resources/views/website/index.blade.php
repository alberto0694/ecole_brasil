...
<div class="row margin-top gray-background padding-20">
...
<div class="row padding-bottom margin-top padding-20 gray-background">
	...
	<div class="col-md-8">
		<h5 class="descricao-day-agenda" style="text-align:left">NOSSA FORMAÇÃO É CERTIFICADA EM ALTO NÍVEL</h5>
		...
		<h3 class="background-ecole-pink" style="text-align: center; color: white; padding: 2px; width: 20%">
...
<div class="row padding-20 background-ecole-pink">
	...
	<div class="col-md-3" style="margin-top: 20px;">
		<h3 style="text-align: center; background: white; padding: 2px;">
			<a class="no-text-decoration gray-dark-color" style="text-decoration:none; font-weight: bold" href="{{ route('contato') }}">Entre em contato</a>
		</h3>
	</div>
