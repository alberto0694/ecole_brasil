...
@section('content')
<div class="row margin-top" style="margin-left: 25px">
...
<div class="row margin-top" style="background: #58595b">
    <div class="container">
...
<div class="row margin-top" style="background: #e5e5e5; padding: 20px">
