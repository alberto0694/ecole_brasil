...
<style type="text/css">
 ...
 <div class="row"></div>
 <div class="row content-equipe" style="margin-bottom: 30px; text-align: center">
 			...
 			<div class="row" style="margin-top:20px">
		 		<div class="col-md-4">
					<div class="cs-item-frame"">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Sophie Pereira</h5>
		 		...
		 		<div class="col-md-4">
					<div class="cs-item-frame"">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Vandressa Pretto</h5>
		 		...
		 		<div class="col-md-4">
					<div class="cs-item-frame"">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Leila Fraga</h5>
...
{{-- 		 		<div class="col-md-4">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Graciela Lech</h5>
 			...
 			<div class="row">
		 		<div class="col-md-4">
					<div class="cs-item-frame"">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Lygia Falcão</h5>
		 			<h5 align="center" class="title-pink-begin-text">Professora</h5>
		 		...
		 		<div class="col-md-4">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Luiza de Bem</h5>
		 		...
		 		<div class="col-md-4">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Kelly Possebon</h5>
 			...
 			<div class="row">
		 		<div class="col-md-4">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Marcela Fabrício</h5>
		 			<h5 align="center" class="title-pink-begin-text">Professora</h5>
		 		...
		 		<div class="col-md-4">
		 			...
		 			<h5 align="center" class="title-pink-begin-text">Patrícia Chiela</h5>
