		...
		<div class="col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1">
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h2 class="title-pink-begin-text">Dúvidas Frequentes</h2>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question1">O QUE É CONSULTORIA DE IMAGEM?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question2">A duração da formação é suficiente para me preparar para o mercado de trabalho?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question3">A formação é obrigatória?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question4">A formação de Consultoria de Imagem é suficiente para atender de forma completa o cliente?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question5">A metodologia, conteúdos e materiais são iguais as da sede em Paris?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="gray-dark-color font-size-title upper-case bold" style="font-weight: bold" data-toggle="collapse" data-target="#question6">RECEBO ALGUM SUPORTE APÓS A CONCLUSÇAO DA FORMAÇÃO?</h4>
