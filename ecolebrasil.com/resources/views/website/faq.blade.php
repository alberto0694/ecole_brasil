...
<div class="row" style="text-align: justify; background: #fff; margin: 0; padding: 0; padding-bottom: 30px">
		...
		<div class="col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1">
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text" data-toggle="collapse" data-target="#question1">O QUE É CONSULTORIA DE IMAGEM?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text upper-case" data-toggle="collapse" data-target="#question2">A duração da formação é suficiente para me preparar para o mercado de trabalho?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text upper-case" data-toggle="collapse" data-target="#question3">A formação é obrigatória?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text upper-case" data-toggle="collapse" data-target="#question4">A formação de Consultoria de Imagem é suficiente para atender de forma completa o cliente?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text upper-case" data-toggle="collapse" data-target="#question5">A metodologia, conteúdos e materiais são iguais as da sede em Paris?</h4>
			...
			<div class="row" style="padding-top: 20px">
				<div class="col-md-8 col-md-offset-2">
					<h4 class="title-pink-begin-text" data-toggle="collapse" data-target="#question6">Recebo algum suporte após a conclusão da formação?</h4>
