						...
						<tr>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a class="red" onclick="return deletar_{{ $formacao->id }}()">
								...
								<div class="hidden-md hidden-lg">
									<div class="inline pos-rel">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											...
											<li>
												<a onclick="return deletar_{{ $formacao->id }}()" class="tooltip-error" data-rel="tooltip" title="Delete">
													<span class="red">
...
<script type="text/javascript">
	@foreach($formacoes as $formacao)
		function deletar_{{$formacao->id}}(){
			$.confirm({
				title: 'Atenção! (Os cursos também serão excluídos!)',
			    ...
			    buttons: {
			        Sim: (helloButton) => {
			            $.ajax({
			              ...
			              type: "DELETE",
			              url: "{{ route('formacao.delete', $formacao->id) }}",
			              data: {},
