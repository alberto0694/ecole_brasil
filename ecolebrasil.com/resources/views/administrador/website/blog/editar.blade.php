...
@section('content')
				...
				<form id="editar-blog" class="form-horizontal" role="form" style="margin-left: 20px">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input value="{{ $blog->titulo }}" id="titulo" name="titulo" type="text" class="col-xs-12 col-sm-6" />
						</div>
					</div>					
					<div class="form-group" >
						<div class="col-sm-9">
								...
								<textarea id="descricao" name="descricao" class="col-xs-12 col-sm-6">
									{{ $blog->descricao }}
								</textarea>							
						</div>	
					</div>
							...
							$.confirm({
							    content: function(){
							        ...
							        return $.ajax({
											  ...
											  data: $("#editar-blog").serialize(),
											  success: function(){
													$.alert({
													    title: 'Sucesso!',
													    content: 'Post cadastrado com sucesso!',
													    buttons:{
													    	ok:function(){
													    		window.location.href = "{{ route('administrador.blog.index') }}";
													    	}
													    }
													});
											  }									  
					...
					$.confirm({
					    ...
					    buttons: {
					        Sim: function(helloButton){
					            document.location.href = "{{ route('administrador.blog.index') }}"
					        },
					        Nao:{
					        	text:"Não"
					        }
