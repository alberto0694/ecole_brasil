...
@section('content')
				...
				<form id="editar-materia" class="form-horizontal" role="form" style="margin-left: 20px">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input value="{{ $imprensa->titulo }}" id="titulo" name="titulo" type="text" class="col-xs-12 col-sm-6" />
						</div>
					</div>					
					<div class="form-group" >
						<div class="col-sm-9">
						...
						submitHandler: function(form) {
							...
							$.confirm({
							    content: function(){
							        ...
							        return $.ajax({
											  type: "POST",
											  url: '{{ route('imprensa.update', $imprensa->id) }}',
											  data: $("#editar-materia").serialize(),
											  success: function(){
													$.alert({
													    title: 'Sucesso!',
