...
@section('content')
				...
				<form id="editar-banner" class="form-horizontal" role="form" style="margin-left: 20px">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input value="{{ $banner->titulo }}" id="titulo" name="titulo" type="text" class="col-xs-12 col-sm-6" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input value="{{ $banner->link_url }}" id="link_url" name="link_url" type="text" class="col-xs-12 col-sm-6" />
						</div>
					</div>
					<div class="form-group">
