					...
					<tr>
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a class="red" onclick="return deletar_{{ $inadimplencia->id }}()">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										...
										<li>
											<a onclick="return deletar_{{ $inadimplencia->id }}()" class="tooltip-error" data-rel="tooltip" title="Delete">
												<span class="red">
...
<script type="text/javascript">
	@foreach($inadimplencias as $inadimplencia)
		function deletar_{{$inadimplencia->id}}(){
			$.confirm({
				title: 'Atenção!',
			    ...
			    buttons: {
			        Sim: (helloButton) => {
			            $.ajax({
			              ...
			              type: "DELETE",
			              url: "{{ route('inadimplencia.delete', $inadimplencia->id) }}",
			              data: {},
