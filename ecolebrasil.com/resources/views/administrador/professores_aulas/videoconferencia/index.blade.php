...
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Ecole Vídeoconferências</h3>

		<div class="clearfix">
			<div class="pull-right tableTools-container"></div>
		</div>
		<div class="table-header">
			Lista de Vídeoconferências
		</div>
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				@foreach($videos as $video)
					<tr>
						...
						<td>{{ $video->modulo->titulo }}</td>
						<td>{{ $video->modulo->agenda->labelCombo }}</td>
						<td><a target="_blank" href="{{ $video->link_video }}">{{ $video->link_video }}</a></td>
						<td>
