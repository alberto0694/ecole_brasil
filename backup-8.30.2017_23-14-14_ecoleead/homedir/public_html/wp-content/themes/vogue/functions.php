 ...
 * @package Vogue
 */
define( 'VOGUE_THEME_VERSION' , '1.3.05' );
...
function remove_footer_admin () {
    echo '© <a href="http://cursosead.escolabrasil.com/">Ecole Brasil</a> - Ecole Brasil';
}
...
background-image: url(".get_bloginfo('template_directory')."/images/logoead.png);
