<footer id="colophon" class="site-footer site-footer-standard" role="contentinfo">
    ...
    <?php if ( get_theme_mod( 'vogue-footer-bottombar', false ) == 0 ) : ?>
		...
		<div class="site-footer-bottom-bar <?php echo ( get_theme_mod( 'vogue-header-layout' ) == 'vogue-header-layout-two' ) ? sanitize_html_class( 'layout-circles' ) : sanitize_html_class( 'layout-plain' ); ?>">
			...
			<?php printf( __( '<div class="site-container"><div class="site-footer-bottom-bar-left">Todos os direitos reservados %1$s by %2$s', 'vogue' ), 'Vogue', '<a href="https://ecolebrasil.com/">Ecole Brasil</a></div><div class="site-footer-bottom-bar-right">' ); ?>
	...
	<?php if ( get_theme_mod( 'vogue-footer-bottombar' ) ) : ?>
		<?php printf( __( '<div class="footer-copyright">Todos os direitos reservados %1$s by %2$s', 'vogue' ), 'Vogue', '<a href="https://ecolebrasil.com/">Ecole Brasil</a></div>' ); ?>
	<?php endif; ?>
