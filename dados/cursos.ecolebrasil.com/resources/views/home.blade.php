        ...
        <div class="col-md-12">
            <div class="panel panel-default" style="margin-bottom: 22px; background-color: #f9f9f9; border: 1px solid transparent; border-radius: 4px; box-shadow: 0 1px 1px rgba(0,0,0,.05);">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="pill" href="#menu1">Módculo 1</a></li>
                                    ...
                                    <div id="conferencia" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=IJIYCiPAm2U&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>
                                    ...
                                    <div id="conferencia_mod2" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=TzIxBmCxV_0&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                                    ...
                                    <div id="conferencia_mod3" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=KxJBekClq_c&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                                    ...
                                    <div id="conferencia_mod4" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=Aroffp0ZFRw&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                                    </div>                             
                                </div>  
                                    ...
                                    <div id="conferencia_mod5" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=A-4nuBU_GUI&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                                    ...
                                    <div id="conferencia_mod6" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=PfCVQZC_LCs&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                                    ...
                                    <div id="conferencia_mod7" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=UzBoeS21NCg&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tab-content" style="margin-top:10px; padding-top:10px">
                                    ...
                                    <div id="texto_mod8" class="tab-pane fade" style="margin-top:10px; padding-top:10px">
                                        ...
                                        <div class="col-md-4">
                                            <label align="center" style="display: block;">
                                                <a href="{{ asset('files/mod_8/NDE_exercicios networking_online.pdf') }}" target="_blank">
                                                    NDE Conteúdo Online
                                                    <img style="margin: 0 auto; display: block;" src="{{ asset('images/pdf.png') }}"/>                                        
                                                </a>
                                            </label>
                                    ...
                                    <div id="material_mod8" class="tab-pane fade">
                                        <div class="col-md-4">
                                            <label align="center" style="display: block;">
                                                <a href="{{ asset('files/mod_8/Coaching_Complementar_NDE.pdf') }}" target="_blank">
                                    ...
                                    <div id="conferencia_mod8" class="tab-pane fade">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">                                                
                                                        ...
                                                        <iframe width="400" height="500" src="https://www.youtube.com/live_chat?v=vDfdkKCCcgo&embed_domain=br356.teste.website" frameborder="0" allowfullscreen></iframe>                                                        
                                                </div>                                
                                        </div>
